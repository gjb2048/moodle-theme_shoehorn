...
class core_renderer extends \core_renderer {
    ...
    public function search_box($id = false) {
        ...
        $searchicon = \theme_shoehorn\toolbox::geticonmarkup('search', 'search', array(), array('title' => get_string('search', 'search')));
        ...
        $inputattrs = array('type' => 'text', 'name' => 'q', 'placeholder' => get_string('search', 'search'),
            'size' => 15, 'tabindex' => -1, 'id' => 'id_q_' . $id);

        $contents = html_writer::tag('label', get_string('enteryoursearchquery', 'search'),
            array('for' => 'id_q_' . $id, 'class' => 'accesshide')) . html_writer::tag('input', '', $inputattrs);
        $searchinput = html_writer::tag('form', $contents, $formattrs);

        return html_writer::tag('li', $searchicon . $searchinput, array('class' => 'search-input-wrapper', 'id' => $id));
    }
